...
public class TestCase10 extends TestBasic{
    ...
    public static void verifyTextSubscription() {
        String subscriptionText=new HomePage(getDriver())
                .getSubscription().
                getText();
        Assert.assertEquals(subscriptionText,
                "SUBSCRIPTION", "Verify text 'SUBSCRIPTION'");
        System.out.println("sub tex "+subscriptionText);
    }
    ...
    Assert.assertEquals(messageAlert,
        "You have been successfully subscribed!",
        "Verify success message 'You have been successfully subscribed!' is visible");
        System.out.println("message alert "+messageAlert);
    }
    }

...
public class TestCase3 extends TestBasic{
    ...
    public void loginUserWithIncorrectEmailAndPassword()  {
        ...
        TestCase2.verifyLoginToYourAccountTxtIsVisible();
    ...
    private void verifyErrorYourEmailOrPasswordIsIncorrectIsVisible(){
        ...
        LoginSignupPage loginPage = new LoginSignupPage(getDriver());

        loginPage.fillIncorrectLogin(email, password);
        SeleniumHelper.waitForElementToBeVisible(getDriver(), loginPage.getErrorLogin());

        String errorLoginText = loginPage.getErrorLogin()
                .getText();

        Assert.assertEquals(errorLoginText,

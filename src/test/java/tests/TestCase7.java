...
@Step("Verify user is navigated to test cases page successfully")
 ...
 //   HomePage homePage = new HomePage(getDriver());
  //  homePage.acceptCookiesIfPresent();   // 👈 TU

    String testCasesText=new HomePage(getDriver())

                .testCasesButtonClick().getTestCases().getText();
    Assert.assertEquals(testCasesText,
            "TEST CASES", "Verify user is navigated to test cases page successfully");
